...
export type Drill = { id: string; name: string; description: string; maxHits: number; distance?: string; notes?: string; googleSheetUrl?: string; libraryVisible?: boolean; passCriteria?: PassCriteria; favorite: boolean; active: boolean; createdAt: string; updatedAt: string };
...
export type Course = { id: string; name: string; description: string; notes?: string; googleSheetUrl?: string; passCriteria?: PassCriteria; entries: CourseEntry[]; favorite: boolean; active: boolean; createdAt: string; updatedAt: string };
